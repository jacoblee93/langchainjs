...
LangChain makes that easy by supporting a few different input values to the `.invoke` method, including strings:

```typescript
const result = await chat.invoke("Translate this sentence from English to French. I love programming.")
// "J'adore programmer."
```
