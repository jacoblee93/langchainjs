...
- [`ApifyWrapper`][ApifyWrapper] - A wrapper around the Apify platform. Useful for web scraping and data extraction.
...
[ApifyWrapper]: /docs/api/tools/classes/ApifyWrapper
